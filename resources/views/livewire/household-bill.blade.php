<div>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="print:hidden md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1 flex justify-between">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium text-gray-900">قبض مشترک خانگی</h3>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6" id="idElement">
            <div class="md:col-span-1 flex justify-between">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium text-gray-900">قبض نهایی مشترک خانگی</h3>
                    ...
                    <div class="px-4 py-8 sm:px-8">
                        ...
                        <table class="text-center border-collapse w-full my-3 bg-gray-100 text-sm shadow-sm">
                          <tbody>
                            ...
                            <tr>
                                <td class="border border-slate-300 p-4 text-slate-۹00 bg-slate-50 font-semibold">بیمه</td>
                                <td class="border border-slate-300 bg-white p-4 text-slate-500">{{$insurance}}</td>
